...
module "cc_asg" {
  source                    = "github.com/zscaler/terraform-aws-cloud-connector-modules//modules/terraform-zscc-asg-aws"
  name_prefix               = var.name_prefix
  resource_tag              = random_string.suffix.result
  global_tags               = local.global_tags
...
################################################################################
module "cc_iam" {
  source             = "github.com/zscaler/terraform-aws-cloud-connector-modules//modules/terraform-zscc-iam-aws"
  name_prefix        = var.name_prefix
  resource_tag       = random_string.suffix.result
  global_tags        = local.global_tags
...
################################################################################
module "cc_sg" {
  source                   = "github.com/zscaler/terraform-aws-cloud-connector-modules//modules/terraform-zscc-sg-aws"
  name_prefix              = var.name_prefix
  resource_tag             = random_string.suffix.result
  global_tags              = local.global_tags
...
################################################################################
module "gwlb" {
  source                = "github.com/zscaler/terraform-aws-cloud-connector-modules//modules/terraform-zscc-gwlb-aws"
...
module "gwlb_endpoint" {
  source              = "github.com/zscaler/terraform-aws-cloud-connector-modules//modules/terraform-zscc-gwlbendpoint-aws"
  name_prefix         = var.name_prefix
  resource_tag        = random_string.suffix.result
  global_tags         = local.global_tags
  vpc_id              = module.network.vpc_id
...
################################################################################
module "asg_lambda" {
  source                  = "github.com/zscaler/terraform-aws-cloud-connector-modules//modules/terraform-zscc-asg-lambda-aws"
  name_prefix             = var.name_prefix
  resource_tag            = random_string.suffix.result
  global_tags             = local.global_tags
